...
class MaiBindings {
  MaiBindings(DynamicLibrary lib)
      : maiRuntimeInit = lib.lookupFunction<
        ...
        maiLoadModel = lib.lookupFunction<Int32 Function(Pointer<RuntimeHandle>, Pointer<Utf8>),
            int Function(Pointer<RuntimeHandle>, Pointer<Utf8>)>('mai_load_model'),
        maiUnloadModel = lib.lookupFunction<Int32 Function(Pointer<RuntimeHandle>),
            int Function(Pointer<RuntimeHandle>)>('mai_unload_model'),
        maiChatCompletion = lib.lookupFunction<
            Int32 Function(Pointer<RuntimeHandle>, Pointer<Utf8>, Pointer<NativeFunction<TokenCallbackNative>>, Pointer<Void>, Pointer<Uint64>),
            int Function(Pointer<RuntimeHandle>, Pointer<Utf8>, Pointer<NativeFunction<TokenCallbackNative>>, Pointer<Void>, Pointer<Uint64>)>('mai_chat_completion'),
        maiCancelCompletion = lib.lookupFunction<Int32 Function(Pointer<RuntimeHandle>, Uint64),
        ...
        maiDeviceProfileJson = lib.lookupFunction<
            ...
            Pointer<Utf8> Function(Pointer<RuntimeHandle>)>('mai_device_profile_json'),
        maiDownloadStart = lib.lookupFunction<
            Int32 Function(Pointer<RuntimeHandle>, Pointer<Utf8>, Pointer<Pointer<Utf8>>),
            int Function(Pointer<RuntimeHandle>, Pointer<Utf8>, Pointer<Pointer<Utf8>>)>(
          'mai_download_start',
        ),
        maiDownloadStatusJson = lib.lookupFunction<
            Pointer<Utf8> Function(Pointer<RuntimeHandle>, Pointer<Utf8>),
            Pointer<Utf8> Function(Pointer<RuntimeHandle>, Pointer<Utf8>)>('mai_download_status_json'),
        maiDownloadListJson = lib.lookupFunction<
            Pointer<Utf8> Function(Pointer<RuntimeHandle>),
            Pointer<Utf8> Function(Pointer<RuntimeHandle>)>('mai_download_list_json'),
        ...
        maiModelCatalogJson = lib.lookupFunction<
            Pointer<Utf8> Function(Pointer<RuntimeHandle>),
            Pointer<Utf8> Function(Pointer<RuntimeHandle>)>('mai_model_catalog_json'),
        maiHubSearchModelsJson = lib.lookupFunction<
            Pointer<Utf8> Function(Pointer<RuntimeHandle>, Pointer<Utf8>),
            Pointer<Utf8> Function(Pointer<RuntimeHandle>, Pointer<Utf8>)>('mai_hub_search_models_json'),
        maiLastErrorMessage = lib.lookupFunction<
  ...
  final int Function(Pointer<RuntimeHandle>, Pointer<Utf8>, Pointer<Pointer<Utf8>>) maiDownloadStart;
  final Pointer<Utf8> Function(Pointer<RuntimeHandle>, Pointer<Utf8>) maiDownloadStatusJson;
  final Pointer<Utf8> Function(Pointer<RuntimeHandle>) maiDownloadListJson;
  final int Function(Pointer<RuntimeHandle>, Pointer<Utf8>, Pointer<Pointer<Utf8>>) maiDownloadRetry;
  final int Function(Pointer<RuntimeHandle>, Pointer<Utf8>) maiDownloadCancel;
  final int Function(Pointer<RuntimeHandle>, Pointer<Utf8>, bool) maiDownloadDelete;
  ...
  final Pointer<Utf8> Function(Pointer<RuntimeHandle>, Pointer<Utf8>) maiHubSearchModelsJson;
